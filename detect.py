...
def detect(imagepath):
    ...
    bound_box_cordinates, weights = HOGCV.detectMultiScale(frame, winStride = (4,4), padding = (45,45), scale = 1.02)
    person = 1
...
def detector(frame):
    ...
    (rects, weights) = HOGCV.detectMultiScale(frame, winStride=(4, 4),padding=(45,45), scale=1.4)
